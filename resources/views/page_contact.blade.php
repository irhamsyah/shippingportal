            ...
            <div class="media-container-column col-lg-8" data-form-type="formoid">
                ...
                @endif
                  ...
                  <input type="hidden" name="email" data-form-email="true" value="DPqZRTuZN7AsJo+awwTjdlILuegF+2KwyO3tud5du//BK3/IpJMpvGPAApP5MSGSIZoVi6dvOmb5NwPthqeD0b3DzGfcvBu2PnGLHEuKvgvxmvcNxXK/ON0gVQAkUxP8">
                    <div class="row">
                        <div hidden="hidden" data-form-alert="" class="alert alert-success col-12">Terimakasih, Data Register anda akan kami proses maksimal 1x24 jam.</div>
                    ...
                    <div class="dragArea row">
                        ...
                        <div data-for="passwordconf" class="col-md-4  form-group">
                            ...
                            <input type="password" name="passwordconf" data-form-field="Passwordconf" class="form-control display-7" id="passwordconf-form1-27">
                        </div>
                        ...
                        <div class="col-md-6  form-group" data-for="city">
                        ...
                        <div data-for="npwpaddress" class="col-md-8 form-group">
                            ...
                            <input type="text" name="npwpaddress" data-form-field="npwpaddress"  class="form-control display-7" id="npwpaddress-form1-27">
                        </div>
